...
const products = [
  ...
  ProductModel(
    ...
    description: 'ore commonly known as green cabbage. the cannoball cabbage is on of the most popular cabbage varieties. It is so named for the way its leaves wound tightly over one.',
    storeName: 'Alisha Mart',
    price: 8.15,
    discount: 6.90,
    stars: 4.5,
